  ...
  class Server < OpenStruct
    ...
    def write_configs
      ...
      File.safe_replace(monit_conf) do |f|
        f.puts %Q(# Monit configuration automagically generated by the "appserver" gem.)
        f.puts %Q(# Include this file into your system's monitrc to use it.)
      ...
      File.safe_replace(nginx_conf) do |f|
        f.puts %Q(# Nginx configuration automagically generated by the "appserver" gem.)
        f.puts %Q(# Include this file into your system's nginx.conf (inside a http statement) to use it.)
